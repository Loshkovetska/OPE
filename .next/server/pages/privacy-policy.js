...
async function getStaticProps() {
  const response = await (0,_api_getDocs__WEBPACK_IMPORTED_MODULE_4__/* .getDocs */ .P)(3);
  return {
    props: {
...
var __webpack_exports__ = __webpack_require__.X(0, [664,342,801,442], () => (__webpack_exec__(5646)));
